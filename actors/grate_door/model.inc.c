...
ALIGNED8 static const Texture grate_door_tex[] = {
#include "actors/star/grate_door_tex.custom.rgba16.inc.c"
};

// 0x0700E860 - 0x0700E8A0
static const Gfx bob_seg7_dl_0700E860[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, grate_door_tex),
    gsDPLoadSync(),
