...
ALIGNED8 const u8 texture_breakable_box_geo_0x8011a90_custom[] = {
#include "actors/breakable_box/breakable_box_geo_0x8011a90_custom.rgba16.inc.c"
};
ALIGNED8 const u8 texture_breakable_box_geo_0x8012290_custom[] = {
#include "actors/breakable_box/breakable_box_geo_0x8012290_custom.rgba16.inc.c"
};

const Vtx VB_breakable_box_geo_0x8012a90[] = {
...
const Vtx VB_breakable_box_geo_0x8012b80[] = {
...
const Light_t Light_breakable_box_geo_0x8011a80 = {
{ 255, 255, 255}, 0, { 255, 255, 255}, 0, { 40, 40, 40}, 0
};

const Ambient_t Light_breakable_box_geo_0x8011a78 = {
{63, 63, 63}, 0, {63, 63, 63}, 0
};

const Gfx DL_breakable_box_geo_0x8012d20[] = {
gsSPDisplayList(DL_breakable_box_geo_0x8012cd8),
gsDPSetTextureImage(0, 2, 1, texture_breakable_box_geo_0x8011a90_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
gsSPBranchList(DL_breakable_box_geo_0x8012c30),
};

const Gfx DL_breakable_box_geo_0x8012cd8[] = {
gsDPPipeSync(),
...
const Gfx DL_breakable_box_geo_0x8012c30[] = {
...
const Gfx DL_breakable_box_geo_0x8012d48[] = {
gsSPDisplayList(DL_breakable_box_geo_0x8012cd8),
gsDPSetTextureImage(0, 2, 1, texture_breakable_box_geo_0x8012290_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
gsSPBranchList(DL_breakable_box_geo_0x8012c30),
};

ALIGNED8 const u8 texture_breakable_box_small_geo_0x8011a90_custom[] = {
#include "actors/breakable_box/breakable_box_small_geo_0x8011a90_custom.rgba16.inc.c"
};
ALIGNED8 const u8 texture_breakable_box_small_geo_0x8012290_custom[] = {
#include "actors/breakable_box/breakable_box_small_geo_0x8012290_custom.rgba16.inc.c"
};

const Vtx VB_breakable_box_small_geo_0x8012a90[] = {
{{{ -100, 0, -100 }, 0, { 992, 0 }, { 129, 0, 0, 255}}},
{{{ -100, 0, 100 }, 0, { 992, 992 }, { 129, 0, 0, 255}}},
{{{ -100, 200, 100 }, 0, { 0, 992 }, { 129, 0, 0, 255}}},
{{{ -100, 0, 100 }, 0, { 0, 992 }, { 0, 0, 127, 255}}},
...
const Vtx VB_breakable_box_small_geo_0x8012b80[] = {
{{{ -100, 200, 100 }, 0, { 0, 0 }, { 0, 127, 0, 255}}},
{{{ 100, 200, -100 }, 0, { 992, 992 }, { 0, 127, 0, 255}}},
{{{ -100, 200, -100 }, 0, { 992, 0 }, { 0, 127, 0, 255}}},
{{{ 100, 200, 100 }, 0, { 0, 992 }, { 0, 127, 0, 255}}},
...
gsDPSetTextureImage(0, 2, 1, texture_breakable_box_small_geo_0x8011a90_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
...
gsSPDisplayList(DL_breakable_box_small_geo_0x8012cd8),
gsDPSetTextureImage(0, 2, 1, texture_breakable_box_small_geo_0x8012290_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
gsSPBranchList(DL_breakable_box_small_geo_0x8012c30),
};
