...
# OMM extract assets
OMM_EXT_ASSETS ?= -1
ifneq ($(OMM_EXT_ASSETS),-1)
  CUSTOM_C_DEFINES += -DOMM_EXT_ASSETS=$(OMM_EXT_ASSETS)
  VERSION_CFLAGS += -DOMM_EXT_ASSETS=$(OMM_EXT_ASSETS)
  DEFINES += OMM_EXT_ASSETS=$(OMM_EXT_ASSETS)
endif
