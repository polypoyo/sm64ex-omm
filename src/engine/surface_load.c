...
void alloc_surface_pools(void) {
    sSurfaceNodePool = main_pool_alloc(24000 * sizeof(struct SurfaceNode), MEMORY_POOL_LEFT);
    sSurfacePool = main_pool_alloc(8000 * sizeof(struct Surface), MEMORY_POOL_LEFT);
