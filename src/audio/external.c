...
#define BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT 0.6f
static const f32 sBackgroundMusicDefaultVolumeFloat[] = {
    /* 00 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 01 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 02 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT * 0.85f,
    /* 03 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 04 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 05 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 06 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT * 1.15f,
    /* 07 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 08 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT * 0.70f,
    /* 09 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 0A */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 0B */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 0C */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 0D */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 0E */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT * 0.85f,
    /* 0F */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 10 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 11 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT * 1.15f,
    /* 12 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 13 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT * 1.15f,
    /* 14 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 15 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 16 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 17 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 18 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 19 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 1A */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 1B */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 1C */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 1D */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 1E */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 1F */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 20 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 21 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 22 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 23 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 24 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT * 0.70f,
    /* 25 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 26 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT * 0.70f,
    /* 27 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT * 1.15f,
    /* 28 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 29 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 2A */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 2B */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT * 0.85f,
    /* 2C */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT * 0.85f,
    /* 2D */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 2E */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 2F */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT * 0.85f,
    /* 30 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT * 0.85f,
    /* 31 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 32 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT * 0.70f,
    /* 33 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 34 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 35 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 36 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 37 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 38 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 39 */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 3A */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 3B */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 3C */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 3D */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 3E */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
    /* 3F */ BACKGROUND_MUSIC_DEFAULT_VOLUME_FLOAT,
};
...
u8 func_803200E4(u16 fadeTimer) {
    ...
    if (gSequencePlayers[SEQ_PLAYER_LEVEL].enabled == TRUE) {
        if (vol != 0xff) {
            ...
            gSequencePlayers[SEQ_PLAYER_LEVEL].volume = sBackgroundMusicDefaultVolumeFloat[sPlayer0CurSeqId];
#endif
...
void set_sequence_player_volume(s32 player, f32 volume) {
    ...
    if (player == SEQ_PLAYER_LEVEL && sPlayer0CurSeqId != SEQUENCE_NONE) {
        struct SequencePlayer *seqPlayer = &gSequencePlayers[player];
        seqPlayer->volume = MIN(seqPlayer->volume, sBackgroundMusicDefaultVolumeFloat[sPlayer0CurSeqId]);
        seqPlayer->fadeVolume = MIN(seqPlayer->fadeVolume, sBackgroundMusicDefaultVolumeFloat[sPlayer0CurSeqId]);
