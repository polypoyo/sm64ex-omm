...
extern const struct MovtexQuadCollection bob_1_Movtex_0[];
extern const struct MovtexQuadCollection castle_courtyard_1_Movtex_0[];
extern const struct MovtexQuadCollection ccm_1_Movtex_0[];
extern const struct MovtexQuadCollection cotmc_1_Movtex_0[];
extern const struct MovtexQuadCollection ddd_1_Movtex_0[];
extern const struct MovtexQuadCollection jrb_1_Movtex_0[];
extern const struct MovtexQuadCollection lll_1_Movtex_0[];
extern const struct MovtexQuadCollection ssl_1_Movtex_0[];
extern const struct MovtexQuadCollection ttc_1_Movtex_0[];
extern const struct MovtexQuadCollection wdw_1_Movtex_0[];
extern const struct MovtexQuadCollection wf_1_Movtex_0[];
    ...
    switch (id) {
        case 20480:
            switch (gCurrLevelNum) {
                case LEVEL_BOB: return (void *) bob_1_Movtex_0;
                case LEVEL_CASTLE_COURTYARD: return (void *) castle_courtyard_1_Movtex_0;
                case LEVEL_CCM: return (void *) ccm_1_Movtex_0;
                case LEVEL_COTMC: return (void *) cotmc_1_Movtex_0;
                case LEVEL_DDD: return (void *) ddd_1_Movtex_0;
                case LEVEL_JRB: return (void *) jrb_1_Movtex_0;
                case LEVEL_LLL: return (void *) lll_1_Movtex_0;
                case LEVEL_SSL: return (void *) ssl_1_Movtex_0;
                case LEVEL_TTC: return (void *) ttc_1_Movtex_0;
                case LEVEL_WDW: return (void *) wdw_1_Movtex_0;
                case LEVEL_WF: return (void *) wf_1_Movtex_0;
            } return NULL;
