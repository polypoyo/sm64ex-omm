...
void bowling_ball_set_waypoints(void) {
    switch (o->oBehParams2ndByte) {
        case BBALL_BP_STYPE_BOB_UPPER:
            o->oPathedStartWaypoint = segmented_to_virtual(ttc_bowling_ball_path);
            break;
        ...
        case BBALL_BP_STYPE_THI_LARGE:
            o->oPathedStartWaypoint = segmented_to_virtual(rr_bowling_ball_path);
            break;
...
#if QOL_FIX_UNUSED_FREE_BOWLING_BALL_COL_FLAGS
