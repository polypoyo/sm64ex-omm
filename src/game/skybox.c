...
extern const u8* const skybox10_skybox_ptrlist[];
extern const u8* const skybox11_skybox_ptrlist[];
extern const u8* const skybox12_skybox_ptrlist[];
extern const u8* const skybox13_skybox_ptrlist[];
extern const u8* const skybox14_skybox_ptrlist[];
...
SkyboxTexture *sSkyboxTextures[] = {
    ...
    &bits_skybox_ptrlist,
    &skybox10_skybox_ptrlist,
    &skybox11_skybox_ptrlist,
    &skybox12_skybox_ptrlist,
    &skybox13_skybox_ptrlist,
    &skybox14_skybox_ptrlist,
};
