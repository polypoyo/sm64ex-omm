...
const struct DialogEntry *const seg2_dialog_table_EE[] = {
#include "dialogsEE.h"
    NULL
};
...
#define COURSE_TABLE_EE seg2_course_name_table_EE
...
#define COURSE_ACTS(id, name, a,b,c,d,e,f) \
    static const u8 act_name_EE_ ## id ## _1[] = { a }; \
    static const u8 act_name_EE_ ## id ## _2[] = { b }; \
    static const u8 act_name_EE_ ## id ## _3[] = { c }; \
    static const u8 act_name_EE_ ## id ## _4[] = { d }; \
    static const u8 act_name_EE_ ## id ## _5[] = { e }; \
    static const u8 act_name_EE_ ## id ## _6[] = { f };
...
#undef EXTRA_TEXT
#define EXTRA_TEXT(id, str) \
    static const u8 extra_text_EE_ ## id[] = { str };
...
#define COURSE_ACTS(id, name, a,b,c,d,e,f) \
    act_name_EE_ ## id ## _1, act_name_EE_ ## id ## _2, act_name_EE_ ## id ## _3, \
    act_name_EE_ ## id ## _4, act_name_EE_ ## id ## _5, act_name_EE_ ## id ## _6,
#define EXTRA_TEXT(id, str) extra_text_EE_ ## id,

const u8 *const seg2_act_name_table_EE[] = {
#include "coursesEE.h"
    NULL
};
