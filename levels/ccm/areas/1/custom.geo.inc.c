const GeoLayout Geo_ccm_1_0x19001700[]= {
...
GEO_NODE_ORTHO(100),
GEO_OPEN_NODE(),
GEO_BACKGROUND(BACKGROUND_CUSTOM_0A, geo_skybox_main),
GEO_CLOSE_NODE(),
GEO_CLOSE_NODE(),
GEO_ZBUFFER(1),
GEO_OPEN_NODE(),
...
GEO_OPEN_NODE(),
GEO_DISPLAY_LIST(4,DL_ccm_1_0xe02f1e0),
GEO_DISPLAY_LIST(6,DL_ccm_1_0xe0473f0),
GEO_RENDER_OBJ(),
