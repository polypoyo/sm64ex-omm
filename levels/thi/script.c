...
static const LevelScript level_thi_POSTLOAD[] = {
...
//AREA 2 LOADS
static const LevelScript level_thi_area2load[] = {
    ALLOC_LEVEL_POOL(),
...
const LevelScript local_objects_thi_1_[] = {
    OBJECT_WITH_ACTS(0,0,232,0,0,90,0,0xa0000, bhvSpinAirborneWarp,31),
...
const LevelScript local_objects_thi_2_[] = {
    OBJECT_WITH_ACTS(0,-710,-260,413,0,135,0,0xa0000, bhvSpinAirborneWarp,31),
