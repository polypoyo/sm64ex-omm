...
OBJECT_WITH_ACTS(56,4385,2330,-3141,0,0,0,0x1010000, bhvCustomSMSRRedOctagonalPlatform,1),
...
OBJECT_WITH_ACTS(84,5059,-1898,-294,0,270,0,0x6b000000, bhvCustomSMSRStaticMessage,63),
...
OBJECT_WITH_ACTS(54,-3173,-1638,1809,0,0,0,0x0, bhvCustomSMSRRedSinkingPlatform,32),
OBJECT_WITH_ACTS(4,-6267,-752,-1461,0,90,0,0x0, bhvCustomSMSRRedWavePlatform,5),
OBJECT_WITH_ACTS(22,823,-1983,-392,0,90,0,0xd0000, bhvWarpPipe,63),
OBJECT_WITH_ACTS(4,-6267,-752,-190,0,90,0,0x30000, bhvCustomSMSRRedWavePlatform,5),
...
OBJECT_WITH_ACTS(56,1920,-573,1952,0,0,0,0x10000, bhvCustomSMSRRedOctagonalPlatform,23),
OBJECT_WITH_ACTS(0,4410,32,-5274,0,90,0,0x0, bhvCoinFormation,63),
OBJECT_WITH_ACTS(4,-6267,-752,-1461,180,90,0,0x0, bhvCustomSMSRRedWavePlatform,10),
OBJECT_WITH_ACTS(54,-1160,1666,-4984,0,0,0,0x0, bhvCustomSMSRRedSinkingPlatform,16),
...
OBJECT_WITH_ACTS(56,2544,-625,3937,0,0,0,0x10000, bhvCustomSMSRRedOctagonalPlatform,8),
OBJECT_WITH_ACTS(137,-7875,328,-4631,0,0,0,0x60000, bhvExclamationBox,217),
OBJECT_WITH_ACTS(56,3228,-215,4611,0,0,0,0x10000, bhvCustomSMSRRedOctagonalPlatform,8),
OBJECT_WITH_ACTS(137,-7341,299,2475,0,0,0,0x70000, bhvExclamationBox,255),
OBJECT_WITH_ACTS(56,4231,195,5204,0,0,0,0x10000, bhvCustomSMSRRedOctagonalPlatform,8),
OBJECT_WITH_ACTS(56,4551,400,5853,0,0,0,0x10000, bhvCustomSMSRRedOctagonalPlatform,8),
...
OBJECT_WITH_ACTS(4,-6267,-752,-190,180,90,0,0x0, bhvCustomSMSRRedWavePlatform,10),
...
OBJECT_WITH_ACTS(56,2948,-625,5143,0,0,0,0x10000, bhvCustomSMSRRedOctagonalPlatform,8),
OBJECT_WITH_ACTS(56,4478,-215,4622,0,0,0,0x10000, bhvCustomSMSRRedOctagonalPlatform,8),
...
OBJECT_WITH_ACTS(54,-5180,1065,-2900,0,0,0,0x0, bhvCustomSMSRRedSinkingPlatform,63),
OBJECT_WITH_ACTS(54,-5180,850,-2356,0,0,0,0x0, bhvCustomSMSRRedSinkingPlatform,63),
OBJECT_WITH_ACTS(54,-5180,656,-1770,0,0,0,0x0, bhvCustomSMSRRedSinkingPlatform,63),
OBJECT_WITH_ACTS(54,-1323,-453,2147,0,0,0,0x0, bhvCustomSMSRRedSinkingPlatform,15),
OBJECT_WITH_ACTS(54,-1160,1368,-4542,0,0,0,0x0, bhvCustomSMSRRedSinkingPlatform,16),
OBJECT_WITH_ACTS(54,-737,-453,2147,0,0,0,0x0, bhvCustomSMSRRedSinkingPlatform,15),
OBJECT_WITH_ACTS(5,865,-754,3579,0,90,0,0x0, bhvCustomSMSRPushableTomb,63),
OBJECT_WITH_ACTS(6,4062,-1570,-1669,0,90,0,0x0, bhvCustomSMSRLampPath,15),
OBJECT_WITH_ACTS(6,4055,-1570,-2369,0,90,0,0x20000, bhvCustomSMSRLampPath,15),
OBJECT_WITH_ACTS(6,3861,-1570,-4327,0,90,0,0x0, bhvCustomSMSRLampPath,15),
OBJECT_WITH_ACTS(7,-3173,-806,1809,0,0,0,0x0, bhvCustomSMSRRotatingDonutPlatform,63),
OBJECT_WITH_ACTS(7,-1997,-806,2152,0,0,0,0x0, bhvCustomSMSRRotatingDonutPlatform,63),
OBJECT_WITH_ACTS(7,-2292,-806,3384,0,0,0,0x0, bhvCustomSMSRRotatingDonutPlatform,63),
RETURN()
};
